...
function library:CreateWindow(options, ...)
	...
	function windowFunctions:CreateDesigner(options, ...)
		...
		local daaata = {{"AddTextbox", "__Designer.Textbox.ImageAssetID", backgroundsection, {
			Name = "Image Asset ID",
			Placeholder = "rbxassetid://12514442821",
			Flag = "__Designer.Background.ImageAssetID",
			Value = "rbxassetid://12514442821",
...
local PepsiUi = library:CreateWindow({
    Name = "Wet Hub version: 1.0 (BETA)",
    Theme = {
        Image = "rbxassetid://12514442821",
        Info = "Dev : Wet Hub Them",
        Background = {
            Asset = "rbxassetid://12514442821"
        }
    }
})
